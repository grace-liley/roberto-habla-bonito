...
const Header = () => {
  return <header className="sticky top-0 z-50 bg-background border-b border-border px-4 py-4">
      <div className="max-w-4xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="hand-drawn text-2xl md:text-3xl text-foreground">
            Roberto
            <span className="block text-base md:text-lg text-muted-foreground">Your Patient Colombian friend</span>
          </h1>
        </div>
        
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="ghost" size="icon" className="touch-target hover:bg-accent/10" aria-label="Open menu">
